...
public class TestFastDFS {
    ...
    public void testFastDFS() throws Exception {
        ...
        //3.加载配置文件
        //D:\taotao\taotao-manager-web\src\main\resources\resource\client.conf
        ClientGlobal.init("D:/taotao/taotao-manager-web/src/main/resources/resource/client.conf");
        ...
        String[] upload_files = storageClient.upload_file("D:/aa.jpg", "jpg", metaList);
